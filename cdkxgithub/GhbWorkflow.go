...
// The jsii proxy struct for GhbWorkflow
type jsiiProxy_GhbWorkflow struct {
	internal.Type__cdkxcoreResource
}

func (j *jsiiProxy_GhbWorkflow) ApiVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiVersion",
...
func (j *jsiiProxy_GhbWorkflow) Node() constructs.Node {
...
func (j *jsiiProxy_GhbWorkflow) Props() *WorkflowProps {
...
func (j *jsiiProxy_GhbWorkflow) ResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceType",
...
// Experimental.
func NewGhbWorkflow(scope constructs.Construct, id *string, props *WorkflowProps) GhbWorkflow {
	_init_.Initialize()

	if err := validateNewGhbWorkflowParameters(scope, id, props); err != nil {
		panic(err)
	}
...
// Experimental.
func NewGhbWorkflow_Override(g GhbWorkflow, scope constructs.Construct, id *string, props *WorkflowProps) {
	_init_.Initialize()
...
// Experimental.
func GhbWorkflow_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGhbWorkflow_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
//
// Experimental.
func GhbWorkflow_IsResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGhbWorkflow_IsResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
//
// Experimental.
func GhbWorkflow_Of(construct constructs.IConstruct) cdkxcore.Resource {
	_init_.Initialize()

	if err := validateGhbWorkflow_OfParameters(construct); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GhbWorkflow) AddDependency(target cdkxcore.Resource) {
...
func (g *jsiiProxy_GhbWorkflow) GetAtt(attr *string) cdkxcore.IResolvable {
...
func (g *jsiiProxy_GhbWorkflow) ToProperties() *map[string]interface{} {
...
func (g *jsiiProxy_GhbWorkflow) ToString() *string {
	var returns *string
...
func (g *jsiiProxy_GhbWorkflow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
